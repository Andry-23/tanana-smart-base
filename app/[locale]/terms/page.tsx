...
export async function generateMetadata({
  ...
  const metadata = dictionary.termsPage.metadata;
      ...
      <section className="relative overflow-hidden bg-[#020817] px-6 py-20 text-white md:py-28">
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <p className="mt-6 text-sm text-slate-400">
            {termsPage.hero.lastUpdatedLabel}:{" "}
            {termsPage.hero.lastUpdatedDate}
          </p>
        </div>
      </section>
            ...
            >
              ...
              <div className="mt-5 leading-7 text-slate-600">
                {section.paragraphs.map((paragraph) => {
                  const privacyToken = "{{privacyPolicy}}";

                  if (!paragraph.includes(privacyToken)) {
                    return (
                      <p
                        key={paragraph}
