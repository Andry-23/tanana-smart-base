    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="mt-12 text-center">
          <Link
            href={buttonHref}
            className="group inline-flex items-center gap-3 rounded-md bg-slate-950 px-6 py-3 font-semibold text-white shadow-lg transition duration-300 hover:-translate-y-0.5 hover:bg-sky-600 hover:shadow-xl"
          >
            {buttonLabel}
