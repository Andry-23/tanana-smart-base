...
export default function CallToAction({
  ...
  title = "Let’s turn your technical need into a reliable engineering solution.",
  description = "We can help define your needs, evaluate practical options and develop a solution adapted to your site, budget and operating conditions.",
